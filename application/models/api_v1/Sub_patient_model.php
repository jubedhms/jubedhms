...
class Sub_patient_model extends CI_Model {
    ...
    public function add_sub_patient(){
        ...
        $this ->db->select('P.ID as parent_id,P.username as parent_username,P.email_id,P.contact_number,P.religious,PA.country_code,PA.city_code,PA.district_code,PA.district_other,PA.postal_code,PA.ward,PA.street,PA.address_line1,PA.address_line2');
