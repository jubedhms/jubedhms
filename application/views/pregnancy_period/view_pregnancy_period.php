							...
							<div class="form-group">
									...
									<?php $pweeks=isset($details->pregnancy_week)?explode(',',$details->pregnancy_week):array();
										...
										<?php } ?>	
                                                                        ...
                                                                        <span class="pregnancy_week_error" style="display: none; color:red;">Please select customer group.</span>
<!--									<span class="error" style="display: none;">
										<i class="error-log fa fa-exclamation-triangle"></i>
									</span>-->
                                                        </div>
						...
						<div class="change_eng col-md-12">
							<div class="form-group">
								<label for="description" class="">Content *</label>
                                                                <span class="description_error" style="display: none; color:red;">Please select customer group.</span>
