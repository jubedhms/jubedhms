								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="password" class="form-control" id="password" name="password" size="12" minlength="8" maxlength="12" value="<?= getFieldVal('password',$details);?>" autocomplete="off" data-rule-required="true" data-msg-required="Please include your password">
											<span class="error" style="display: none;">
											<i class="error-log fa fa-exclamation-triangle"></i>
											</span>
										</div>
							...
							<div class="col-md-3 widget-holder">
								<div class="widget-bg">
									<div class="widget-body---">
										<div class="col-md-12">
											<input type="file" class="form-control choose-image" id="image" name="image" accept=".jpg,.jpeg,.png" data-min-size="10" data-max-size="1000" table-id="<?=$ID;?>" action="<?=$this->main_page;?>/change_image" show-image-src=".view_image" show-image-href=".image-lightbox" <?=($ID=='')?'data-rule-required="true" data-msg-required="Please select employee profile image"':'';?> style="opacity:0;height:0px;width:0px;">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="box-footer text-center">
										...
										<a href="javascript:void(0)" class="btn btn-info" data-toggle="modal" data-target=".bs-modal-module-access">Assign access</a>
	...
	<div class="modal modal-info fade bs-modal-changePassword" id="changePassword" tabindex="-1" role="dialog" aria-labelledby="myMediumModalLabel2" aria-hidden="true" style="display: none">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<form class="" accept-charset="UTF-8" enctype="multipart/form-data" method="post" action="<?= base_url('user/change_password_via_admin');?>" autocomplete="off">
				<div class="modal-body">
