					...
					<div class="widget-body clearfix">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="hidden" name="ID" id="ID" value="<?= md5($details->ID); ?>" readonly="true">
											
											<input type="hidden" name="role_id" value="<?= getFieldVal('role_id',$details);?>" readonly="true">
											
											<input type="hidden" name="user_id" id="user_id" value="<?= ($ID!='')?$ID:''; ?>">
											
											<label for="user_name" class="">Username *</label>
											<input type="email" class="form-control checkNotExistEmpUsername" name="user_name" id="user_name"  value="<?= getFieldVal('user_name',$details);?>" <?=(getFieldVal('user_name',$details)!='')?"disabled":""?> autocomplete="off" readonly="true" required="required" data-rule-required="true" data-msg-required="Please include your Username">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select-other" id="team" name="team" readonly="true" required="required" data-rule-required="true" data-msg-required="Please Select team">
												<?php 
													$teams=['IT'=>'IT','Marketing'=>'Marketing','Operation'=>'Operation','Customer Service'=>'Customer Service','Front office'=>'Front office','Pharmacy'=>'Pharmacy','editable'=>'Other'];
													...
													foreach($teams as $key=>$value){
														if($key == getFieldVal('team',$details)){
												?>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" readonly="true" required="required" data-rule-required="true" data-msg-required="Please select Employee role." >
												<?php 
													if($role_details && count($role_details)>0){
													foreach($role_details as $role){
													
													if($role->ID == getFieldVal('role_id',$details)){	
												?>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select-other" id="title" name="title" value="<?= getFieldVal('title',$details);?>" list="titles" readonly="true" required="required" data-rule-required="true" data-msg-required="Please select Title.">
												<?php 
													...
													foreach($titles as $key=>$value){
														if($key== getFieldVal('title',$details)){
												?>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="first_name" name="first_name" value="<?= getFieldVal('first_name',$details);?>" readonly="true" required="required" data-rule-required="true" data-msg-required="Please include your First Name">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
						...
						<div class="row">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="middle_name" name="middle_name" value="<?= getFieldVal('middle_name',$details);?>" readonly="true">
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="last_name" name="last_name" value="<?= getFieldVal('last_name',$details);?>" readonly="true">
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="email" class="form-control" id="email_id" name="email_id" value="<?= getFieldVal('email_id',$details);?>" autocomplete="off" readonly="true" required="required" data-rule-required="true" data-msg-required="Please include your Email address">
											<span class="error" style="display: none;">
											<i class="error-log fa fa-exclamation-triangle"></i>
											</span>
										</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea name="description" class="form-control" data-toggle="wysiwyg" readonly="true" required="required"><?=getFieldVal('description',$details)?></textarea>
								</div>
							</div>
						</div>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="">
					...
					<input type="password" class="form-control old_password" id="old_password" name="old_password" readonly="true" required="required" size="12" minlength="8" maxlength="12" data-rule-required="true"  data-msg-required="Please enter a valid Password" autocomplete="off">
					<span class="error" style="display: none;">
						<i class="error-log fa fa-exclamation-triangle"></i>
					</span>
				</div>
				...
				<div class="">
					...
					<input id="password" name="password" class="form-control password" readonly="true" required="required" size="12" minlength="8" maxlength="12" type="password"  data-rule-required="true"  data-msg-required="Please enter a valid Password" autocomplete="off">
					<span class="error" style="display: none;">
						<i class="error-log fa fa-exclamation-triangle"></i>
					</span>
				</div>
				...
				<div class="">
					...
					<input id="confirm_password" name="confirm_password" class="form-control confirm_password" readonly="true" required="required" size="12" minlength="8" maxlength="12"  type="password" data-rule-equalTo="#password" data-rule-required="true" data-msg-required="Please enter a valid confirm Password" autocomplete="off">
