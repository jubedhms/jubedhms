...
<script>
    ...
    $(document).on('change', 'select[name="profile_specialty"]', function () {
        //alert( $(this).find('option:selected').text());
        if ($(this).find('option:selected').text() == 'Other') {
            $('#profile_specialty_other').removeClass('hidden');
        } else {
            $('#profile_specialty_other').addClass('hidden');
        }
    })
    ...
    $(document).on('change', 'select[name="profile_specialty_vi"]', function () {
        if ($(this).find('option:selected').text() == 'Other') {
            $('#profile_specialty_other_vi').removeClass('hidden');
        } else {
            $('#profile_specialty_other_vi').addClass('hidden');
        }
    })
