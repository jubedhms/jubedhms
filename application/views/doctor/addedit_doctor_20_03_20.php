                                ...
                                <div class="row">
                                    <div class="col-md-8 widget-holder">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="specialty_code[]" class="specialty_b">Specialty</label>
                                                    <select class="form-control specialty" id="specialty_code" name="specialty_code[]" multiple="multiple">
                                                        <?php
                                                        if ($doctor_specialization && count($doctor_specialization) > 0) {
                                                            $dept_code = (isset($details->specialty_code) && $details->specialty_code != '') ? explode(',', $details->specialty_code) : array();
                                                            foreach ($doctor_specialization as $specialty) {
                                                                ?>
                                                                <option value="<?= $specialty->code; ?>" <?= in_array($specialty->code, $dept_code) ? "selected" : ""; ?>><?= $specialty->name; ?></option>
    <?php }
} ?>
                                                    </select>
                                                </div>
                                        ...
                                        <table class="table table-striped table-responsive">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="add_delete_b">Add/Delete</th>
                                                </tr>
                                            </thead>
    ...
    foreach ($details->educations as $edurow) {
        if ($i > 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="width: 120px;position: relative;left: 15px; "><span edu_id="<?= $edurow->ID; ?>" class="btn btn-sm btn-danger remove_education">-</span></td>
        ...
        <?php } else { ?>
                                                        <tr>
                                                            ...
                                                            <td style="width: 120px;position: relative;left: 15px; "><span edu_id="<?= $edurow->ID; ?>" class="btn btn-sm btn-primary add_more_education">+</span></td>
...
<?php if (!isset($details->educations)) { //add condition  ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 120px;position: relative;left: 15px; "><span class="btn btn-sm btn-primary add_more_education">+</span></td>
    ...
    foreach ($details->experiences as $expurow) {
        if ($i > 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td><span exp_id="<?= $expurow->ID; ?>" class="btn btn-sm btn-danger remove_experience">-</span></td>
        ...
        <?php } else { ?>
                                                        <tr>
                                                            ...
                                                            <td><span exp_id="<?= $expurow->ID; ?>" class="btn btn-sm btn-primary add_more_experience">+</span></td>
        ...
        <?php } $i++;
                                            ...
                                            <?php if (!isset($details->experiences)) { //add condition ?>
                                                <tr>
                                                    ...
                                                    <td><span class="btn btn-sm btn-primary add_more_experience">+</span></td>
...
<script>
    ...
    function  preview() {
        ...
        var doctor_dept = $('#primary_specialty_code :selected').text(); //myContent.replace(/(<([^>]+)>)/ig,"");
...
//        //$('.doctor_dept:first').p('<i class="fa fa-graduation-cap" aria-hidden="true"></i> &nbsp;');
        ...
        $('.doctor_specialty').html(doctor_dept);
