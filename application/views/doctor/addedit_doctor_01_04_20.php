                                ...
                                <div class="row">
                                    <div class="col-md-8 widget-holder">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="name_b">Name *</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="primary_specialty_code" name="primary_specialty_code" style="pointer-events: none;background-color: #f5f5f5;">
                                                        <option value="">Select</option>
                                                        <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="" class="specialty_b">Specialty</label>
                                                    <select class="form-control specialty" id="specialty_code" name="specialty_code">
                                                        <option value="">Select</option>
                                                        <?php
                                                        if ($doctor_specialization && count($doctor_specialization) > 0) {
                                                            $dept_code = (isset($details->specialty_code) && $details->specialty_code != '') ? $details->specialty_code : '';
                                                            foreach ($doctor_specialization as $specialty) {
                                                                ?>
                                                                <option value="<?= $specialty->code; ?>" <?= (isset($dept_code) && $specialty->code==$dept_code) ? "selected" : ""; ?>><?= $specialty->name; ?></option>
                                                        <?php } } ?>
                                                                <!--<option value="Other">Other</option>-->
                                                    </select>
<!--                                                    <input type="text" class="form-control other_specilty <?php //echo (isset($details->other_specilty) && $details->other_specilty == 'Other') ? '' : 'hidden'; ?>" value="<?php //echo (isset($details->other_specilty) && $details->position == 'Other') ? $details->other_specilty : ''; ?>" id="specilty_other" name="position_other" placeholder='Enter other specialty'>
                                                    <span class="position_error" style="display: none;">Please select Position.</span>  -->
...
<!--                                                    <div class="col-md-12"  >
                                                        <div class="blog-post">
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <input type="file" class="form-control" id="image" name="image" accept=".jpg,.jpeg,.png" data-min-size="10" data-max-size="1000" table-id="<?= $ID; ?>"  <?= ($ID == '') ? 'data-rule-required="true" data-msg-required="Please select Doctor profile image"' : ''; ?>>  
...
<?php } ?>
                                ...
                                <div class="row description_en" style="margin-top: 20px;">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="row description_vi" style="display:none;margin-top: 20px;">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="row professional_exp_year">
                                    <div class="col-md-4">
                                        <table class="table table-striped table-responsive">
                                            <thead>
                                                <tr>
                                                    <th style="width: 90%;"><label class="professional_exp_year_b">YEARS OF PROFESSIONAL EXPERIENCE</label></th>
                                                    <th class=""></th>
                                                </tr>
                                            </thead>
                                            <tbody class="">
                                        ...
                                        <table class="table table-striped table-responsive">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="add_delete_b" style="text-align: right;">Add/Delete</th>
                                                </tr>
                                            </thead>
    ...
    foreach ($details->educations as $edurow) {
        if ($i > 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="width: 120px;position: relative;text-align: right;padding-right: 30px;"><span edu_id="<?= $edurow->ID; ?>" class="btn btn-sm btn-danger remove_education">-</span></td>
        ...
        <?php } else { ?>
                                                        <tr>
                                                            ...
                                                            <td style="width: 120px;position: relative;text-align: right;padding-right: 30px;"><span edu_id="<?= $edurow->ID; ?>" class="btn btn-sm btn-primary add_more_education">+</span></td>
...
<?php if (!isset($details->educations)) { //add condition  ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 120px;position: relative;text-align: right;padding-right: 30px; "><span class="btn btn-sm btn-primary add_more_education">+</span></td>
    ...
    foreach ($details->experiences as $expurow) {
        if ($i > 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right;padding-right: 30px;"><span exp_id="<?= $expurow->ID; ?>" class="btn btn-sm btn-danger remove_experience">-</span></td>
        ...
        <?php } else { ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right;padding-right: 30px;"><span exp_id="<?= $expurow->ID; ?>" class="btn btn-sm btn-primary add_more_experience">+</span></td>
        ...
        <?php } $i++;
                                            ...
                                            <?php if (!isset($details->experiences)) { //add condition ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: right;padding-right: 30px;"><span class="btn btn-sm btn-primary add_more_experience">+</span></td>
...
$(document).ready(function(){
  ...
  $('.crop_image').click(function(event){
    $image_crop.croppie('result', {
      ...
      $.ajax({
        url:"upload.php",
        url:BASE_URL+'doctor/Doctor_imageUpload',
        type: "POST",
