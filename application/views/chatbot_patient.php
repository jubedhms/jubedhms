...
<script>
    ...
    $(document).on('click','.check_mark',function(){
        ...
        if($(this).val()){
            $.post(BASE_URL+'chat_patient/chatBotOption',{message:$(this).val(),question:$('.subparent').data('question'),subparent:subparent,name:$('.patient_nameN').val(),username:$('.patient_usernameN').val()},function(data){
                if(data){
...
$(document).on('click','.openChat',function(){
    $.post(BASE_URL+'chat_patient/openChat',{username:$(".patient_usernameN").val()},function(data){
...
$(document).on('click','.replyChatN',function(){
    ...
    $.post(BASE_URL+'chat_patient/revert_from_patient',{message:msg,subparent:subparent,question:question,name:$('.patient_nameN').val(),username:$('.patient_usernameN').val()},function(data){
        $('.replymessageN').val('');
        $('.chatbox-messages').html('');
        $('.chatbox-messages').html(data);
    ...
    if(msg=='Yes'){
//                    $.post(BASE_URL+'chat_patient/getquestion',{ID:$('.patient_idN').val(),message:msg,name:$('.patient_name').val()},function(data){
//                    $('.messages').html('');
//                    $('.messages').html(data);
//                    $('.replymessageN').val('');
//                });
    }else if(msg=='No'){
//                    $.post(BASE_URL+'chat_patient/replyChat',{ID:$('.patient_idN').val(),message:msg,name:$('.patient_name').val()},function(data){
//                    $('.messages').html('');
//                    $('.messages').html(data);
//                    $('.replymessageN').val('');
//                });
