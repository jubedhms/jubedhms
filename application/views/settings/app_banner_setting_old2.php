                        ...
                        <div class="row" >
                                ...
                                <div class="col-md-3 mr-b-30 tourg_box">
                                    <div class="card blog-post-new">
                                        <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($rowtour->ID) ?>" wth="<?php echo isset($rowtour->width) ? $rowtour->width : ''; ?>" hth="<?php echo isset($rowtour->height) ? $rowtour->height : ''; ?>"></span>
                                                        <a href="javascript:void(0);" <?php echo ($rowtour->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($rowtour->ID) ?>" image_size="1" >
                            ...
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($rowtour->ID) ?>" wth="<?php echo isset($rowtour->width) ? $rowtour->width : ''; ?>" hth="<?php echo isset($rowtour->height) ? $rowtour->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($rowtour->ID) ?>" image_size="1" >
                    ...
                    <div class="widget-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 mr-b-30 tourg_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(7) ?>" wth="<?php echo isset($details[6]->width) ? $details[6]->width : ''; ?>" hth="<?php echo isset($details[6]->height) ? $details[6]->height : ''; ?>"></span>
                                        <a href="javascript:void(0);" <?php echo ($details[6]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(7) ?>" image_size="1" >
                        ...
                        <?php } ?>
                            ...
                            <div class="col-md-3 mr-b-30 tourg_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(8) ?>" wth="<?php echo isset($details[7]->width) ? $details[7]->width : ''; ?>" hth="<?php echo isset($details[7]->height) ? $details[7]->height : ''; ?>"></span>

                                        <a href="javascript:void(0);" <?php echo ($details[7]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(8) ?>" image_size="1" >
                            ...
                            <div class="col-md-3 mr-b-30 tourg_box">
                                    ...
                                    <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                            <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(39) ?>" wth="<?php echo isset($details[38]->width) ? $details[38]->width : ''; ?>" hth="<?php echo isset($details[38]->height) ? $details[38]->height : ''; ?>"></span>

                                            <a href="javascript:void(0);" <?php echo ($details[38]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(39) ?>" image_size="1" >
                            ...
                            <div class="col-md-3 mr-b-30 tourg_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(40) ?>" wth="<?php echo isset($details[39]->width) ? $details[39]->width : ''; ?>" hth="<?php echo isset($details[39]->height) ? $details[39]->height : ''; ?>"></span>

                                        <a href="javascript:void(0);" <?php echo ($details[39]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(40) ?>" image_size="1" >
                        ...
                        <div class="col-md-3 mr-b-30 tourg_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(41) ?>" wth="<?php echo isset($details[40]->width) ? $details[40]->width : ''; ?>" hth="<?php echo isset($details[40]->height) ? $details[40]->height : ''; ?>"></span>

                                        <a href="javascript:void(0);" <?php echo ($details[40]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(41) ?>" image_size="1" >
                            ...
                            <div class="col-md-3 mr-b-30 tourg_box">
                                    ...
                                    <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                            <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(42) ?>" wth="<?php echo isset($details[41]->width) ? $details[41]->width : ''; ?>" hth="<?php echo isset($details[41]->height) ? $details[41]->height : ''; ?>"></span>

                                            <a href="javascript:void(0);" <?php echo ($details[41]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(42) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                        ...
                        <div class="row" >
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                                <figure>
                                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($pasntrow->ID) ?>" wth="<?php echo isset($pasntrow->width) ? $pasntrow->width : ''; ?>" hth="<?php echo isset($pasntrow->height) ? $pasntrow->height : ''; ?>"></span>
                                                        <a href="javascript:void(0);" <?php echo ($pasntrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($pasntrow->ID) ?>" image_size="1" >
                             ...
                             <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($pasntrow->ID) ?>" wth="<?php echo isset($pasntrow->width) ? $pasntrow->width : ''; ?>" hth="<?php echo isset($pasntrow->height) ? $pasntrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($pasntrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                       ...
                       <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($hrow->ID) ?>" wth="<?php echo isset($hrow->width) ? $hrow->width : ''; ?>" hth="<?php echo isset($hrow->height) ? $hrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($hrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($hrow->ID) ?>" image_size="1" >
                            ...
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($hrow->ID) ?>" wth="<?php echo isset($hrow->width) ? $hrow->width : ''; ?>" hth="<?php echo isset($hrow->height) ? $hrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($hrow->ID) ?>" image_size="1" >
                    ...
                    <div class="widget-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mr-b-30 haw_box">
                                        ...
                                        <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                                <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(35) ?>" wth="<?php echo isset($details[34]->width) ? $details[34]->width : ''; ?>" hth="<?php echo isset($details[34]->height) ? $details[34]->height : ''; ?>"></span>

                                                <a href="javascript:void(0);" <?php echo ($details[34]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(35) ?>" image_size="1" >
                            ...
                            <div class="col-md-3 mr-b-30 haw_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(9) ?>" wth="<?php echo isset($details[8]->width) ? $details[8]->width : ''; ?>" hth="<?php echo isset($details[8]->height) ? $details[8]->height : ''; ?>"></span>

                                        <a href="javascript:void(0);" <?php echo ($details[8]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(9) ?>" image_size="1" >
                            ...
                            <div class="col-md-3 mr-b-30 haw_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(10) ?>" wth="<?php echo isset($details[9]->width) ? $details[9]->width : ''; ?>" hth="<?php echo isset($details[9]->height) ? $details[9]->height : ''; ?>"></span>

                                        <a href="javascript:void(0);" <?php echo ($details[9]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(10) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                        ...
                        <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($bookrow->ID) ?>" wth="<?php echo isset($bookrow->width) ? $bookrow->width : ''; ?>" hth="<?php echo isset($bookrow->height) ? $bookrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($bookrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($bookrow->ID) ?>" image_size="1" >
                            ...
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($bookrow->ID) ?>" wth="<?php echo isset($bookrow->width) ? $bookrow->width : ''; ?>" hth="<?php echo isset($bookrow->height) ? $bookrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($bookrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                       ...
                       <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($doctorrow->ID) ?>" wth="<?php echo isset($doctorrow->width) ? $doctorrow->width : ''; ?>" hth="<?php echo isset($doctorrow->height) ? $doctorrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($doctorrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($doctorrow->ID) ?>" image_size="1" >
                           ...
                           <?php } ?>
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($doctorrow->ID) ?>" wth="<?php echo isset($doctorrow->width) ? $doctorrow->width : ''; ?>" hth="<?php echo isset($doctorrow->height) ? $doctorrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($doctorrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                        ...
                        <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($alldoctorrow->ID) ?>" wth="<?php echo isset($alldoctorrow->width) ? $alldoctorrow->width : ''; ?>" hth="<?php echo isset($alldoctorrow->height) ? $alldoctorrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($alldoctorrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($alldoctorrow->ID) ?>" image_size="1" >
                            ...
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($alldoctorrow->ID) ?>" wth="<?php echo isset($alldoctorrow->width) ? $alldoctorrow->width : ''; ?>" hth="<?php echo isset($alldoctorrow->height) ? $alldoctorrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($alldoctorrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                        ...
                        <div class="row" >
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                                <figure>
                                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($docdtrow->ID) ?>" wth="<?php echo isset($docdtrow->width) ? $docdtrow->width : ''; ?>" hth="<?php echo isset($docdtrow->height) ? $docdtrow->height : ''; ?>"></span>
                                                        <a href="javascript:void(0);" <?php echo ($docdtrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($docdtrow->ID) ?>" image_size="1" >
                            ...
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($docdtrow->ID) ?>" wth="<?php echo isset($docdtrow->width) ? $docdtrow->width : ''; ?>" hth="<?php echo isset($docdtrow->height) ? $docdtrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($docdtrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                       ...
                       <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($vacntrow->ID) ?>" wth="<?php echo isset($vacntrow->width) ? $vacntrow->width : ''; ?>" hth="<?php echo isset($vacntrow->height) ? $vacntrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($vacntrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($vacntrow->ID) ?>" image_size="1" >
                           ...
                           <?php }  ?>
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($vacntrow->ID) ?>" wth="<?php echo isset($vacntrow->width) ? $vacntrow->width : ''; ?>" hth="<?php echo isset($vacntrow->height) ? $vacntrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($vacntrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                       ...
                       <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($shoptrow->ID) ?>" wth="<?php echo isset($shoptrow->width) ? $shoptrow->width : ''; ?>" hth="<?php echo isset($shoptrow->height) ? $shoptrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($shoptrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($shoptrow->ID) ?>" image_size="1" >
                           ...
                           <?php }  ?>
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($shoptrow->ID) ?>" wth="<?php echo isset($shoptrow->width) ? $shoptrow->width : ''; ?>" hth="<?php echo isset($shoptrow->height) ? $shoptrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($shoptrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                        ...
                        <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($aboutrow->ID) ?>" wth="<?php echo isset($aboutrow->width) ? $aboutrow->width : ''; ?>" hth="<?php echo isset($aboutrow->height) ? $aboutrow->height : ''; ?>"></span>
                                                    <a href="javascript:void(0);" <?php echo ($aboutrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($aboutrow->ID) ?>" image_size="1" >
                            ...
                            <!--TO ADD MORE-->
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                                <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($aboutrow->ID) ?>" wth="<?php echo isset($aboutrow->width) ? $aboutrow->width : ''; ?>" hth="<?php echo isset($aboutrow->height) ? $aboutrow->height : ''; ?>"></span>
                                                <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($aboutrow->ID) ?>" image_size="1" >
                ...
                <div class="widget-bg-transparent">
                    <div class="widget-body">
                        ...
                        <div class="row" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                <figure>
                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($pregnancyrow->ID) ?>" wth="<?php echo isset($pregnancyrow->width) ? $pregnancyrow->width : ''; ?>" hth="<?php echo isset($pregnancyrow->height) ? $pregnancyrow->height : ''; ?>"></span>
                                    <a href="javascript:void(0);" <?php echo ($pregnancyrow->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5($pregnancyrow->ID) ?>" image_size="1" >
                            ...
                            <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                <figure>
                                    <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5($pregnancyrow->ID) ?>" wth="<?php echo isset($pregnancyrow->width) ? $pregnancyrow->width : ''; ?>" hth="<?php echo isset($pregnancyrow->height) ? $pregnancyrow->height : ''; ?>"></span>
                                    <a href="javascript:void(0);" style="cursor:auto" data-toggle="modal" class="upload_img_btn" title="Click to add more image"  data-id="<?= md5($pregnancyrow->ID) ?>" image_size="1" >
                        ...
                        <div class="row">
                            <div class="col-md-3 mr-b-30 fertility_box">
                                ...
                                <div class="card blog-post-new">
                                    <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                            <figure>
                                            <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(90) ?>" wth="<?php echo isset($details[89]->width) ? $details[89]->width : ''; ?>" hth="<?php echo isset($details[89]->height) ? $details[89]->height : ''; ?>"></span>

                                            <a href="javascript:void(0);" <?php echo ($details[89]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(90) ?>" image_size="1" >
                            ...
                            <div class="col-md-3 mr-b-30 haw_box">
                                ...
                                <div class="card-header sub-heading-font-family border-bottom-0 p-0">
                                        <figure>
                                        <span style="display: none;" data-toggle="modal" class="upload_img_btn" data-id="<?= md5(91) ?>" wth="<?php echo isset($details[90]->width) ? $details[90]->width : ''; ?>" hth="<?php echo isset($details[90]->height) ? $details[90]->height : ''; ?>"></span>

                                        <a href="javascript:void(0);" <?php echo ($details[90]->src)?'style="cursor:auto"':'data-toggle="modal" class="upload_img_btn" title="Click to change image"'?>  data-id="<?= md5(91) ?>" image_size="1" >
    ...
    function readURL(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $("#imgpreviewmobile").attr('src', e.target.result);
                //dimention check
