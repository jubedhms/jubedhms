...
$(document).on('click','.replyChatN',function(){
    ...
    $.post(BASE_URL+'chat/revert_from_support',{message:msg,name:$('.patient_nameN').val(),username:$('.patient_usernameN').val()},function(data){
    ...
    if(msg=='Yes'){
//                    $.post(BASE_URL+'chat/getquestion',{ID:$('.patient_idN').val(),message:msg,name:$('.patient_name').val()},function(data){
//                    $('.messages').html('');
//                    $('.messages').html(data);
//                    $('.replymessageN').val('');
//                });
    }else if(msg=='No'){
//                    $.post(BASE_URL+'chat/replyChat',{ID:$('.patient_idN').val(),message:msg,name:$('.patient_name').val()},function(data){
//                    $('.messages').html('');
//                    $('.messages').html(data);
//                    $('.replymessageN').val('');
//                });
...
$(document).on('click','.patientChatN',function(){
    ...
    $.post(BASE_URL+'chat/openChat',{username:$(this).data('usernamen')},function(data){
        $('.chatbox-messages').html('');
