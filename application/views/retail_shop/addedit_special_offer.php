						...
						<div class="row">
							<div class="col-md-9 widget-holder">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="offer_id" class="">offer ID *</label>
											<input type="text" class="form-control <?=($ID!='')?'checkSecondExistOfferID':'checkExistOfferID'?>" id="offer_id" name="offer_id" value="<?= getFieldVal('offer_id',$details);?>" data-rule-required="true" data-msg-required="Please include your offer ID">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control number" id="list_price" name="list_price" value="<?= (isset($details->list_price) && $details->list_price>0)?$details->list_price:'0.00';?>"  step="any" data-rule-required="true" data-msg-required="Please include offer original price">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
									...
									<div class="col-md-6"> 
										<div class="form-group">
											...
											<input type="number" class="form-control number" id="discount_percent" name="discount_percent" value="<?= (isset($details->discount_percent) && $details->discount_percent>0)?(fmod($details->discount_percent, 1)?$details->discount_percent:(int)$details->discount_percent):'0';?>" step="number" data-rule-required="true" data-msg-required="Please include offer discount percentage">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span> 
										</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control number" id="discount_amount" name="discount_amount" value="<?= (isset($details->discount_amount) && $details->discount_amount>0)?$details->discount_amount:'0.00';?>" step="any" data-rule-required="true" data-msg-required="Please include offer discount amount">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span> 
										</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control number" id="sale_price" name="sale_price" value="<?= (isset($details->sale_price) && $details->sale_price>0)?$details->sale_price:'0.00';?>" readonly="true" data-rule-required="true" step="any" data-msg-required="Please include offer sale price">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
							...
							<div class="col-md-3 widget-holder">
								<div class="widget-bg">
									<div class="widget-body---">
										<div class="col-md-12">
											<input type="file" class="form-control choose-image" id="image" name="image" accept=".jpg,.jpeg,.png" data-min-size="10" data-max-size="1000" table-id="<?=$ID;?>" action="<?=$this->main_page;?>/change_image" show-image-src=".view_image" show-image-href=".image-lightbox" <?=($ID=='')?'data-rule-required="true" data-msg-required="Please include offer Image"':'';?> style="opacity:0;height:0px;width:0px;">
										...
										<div class="col-md-12">
											<div class="blog-post blog-post-card text-center">
												<figure id="offer_image" style="height:175px;">
