								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="offer_id" name="offer_id" value="<?= getFieldVal('offer_id',$details);?>" data-rule-required="true" data-msg-required="Please include your offer ID">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control number" id="sale_price" name="sale_price" value="<?= (isset($details->sale_price) && $details->sale_price>0)?$details->sale_price:'0.00';?>" readonly="readonly" data-rule-required="true" step="any" data-msg-required="Please include offer sale price">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
