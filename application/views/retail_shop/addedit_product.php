								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control <?=($ID!='')?'checkSecondExistProductID':'checkExistProductID'?>" id="product_id" name="product_id" value="<?= getFieldVal('product_id',$details);?>" data-rule-required="true" data-msg-required="Please include your Product ID">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
							...
							<div class="col-md-3 widget-holder">
								<div class="widget-bg">
									<div class="widget-body---">
										<div class="col-md-12">
											<input type="file" class="form-control choose-image" id="image" name="image" accept=".jpg,.jpeg,.png" data-min-size="10" data-max-size="1000" table-id="<?=$ID;?>" action="<?=$this->main_page;?>/change_image" show-image-src=".view_image" show-image-href=".image-lightbox" <?=($ID=='')?'data-rule-required="true" data-msg-required="Please include product Image"':'';?> style="opacity:0;height:0px;width:0px;">
