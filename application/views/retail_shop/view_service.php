								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="service_id" name="service_id" value="<?= getFieldVal('service_id',$details);?>" data-rule-required="true" data-msg-required="Please include your service ID">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control number" id="sale_price" name="sale_price" value="<?= (isset($details->sale_price) && $details->sale_price>0)?$details->sale_price:'0.00';?>" readonly="readonly" data-rule-required="true" step="any" data-msg-required="Please include service sale price">
											<span class="error" style="display: none;">
												<i class="error-log fa fa-exclamation-triangle"></i>
											</span>  
										</div>
