...
<!-- Page Title Area -->
	<div class="row page-title clearfix">
		...
		<div class="page-title-right d-none d-sm-inline-flex">
			...
			<a href="<?=base_url('vaccine_appointment/addedit_appointment');?>" class="btn btn-info btn-sm">New Appointment</a>
			<?php } if(checkModulePermission($MODULEID,'delete_btn')){ ?>
			<a href="javascript:void(0)" class="btn btn-danger btn-sm bulk_delete" id="<? //=base_url('vaccine_appointment/deleteData');?>" title="Delete selected rows">Delete Selected</a>
			<?php }?>
			</span>-->
		</div>
	<!-- /.page-title-right -->
                        ...
                        <div class="dropdown">
							...
							<div class="dropdown-menu  dropdown-menu-left">
								<?php if(checkModulePermission($MODULEID,'view_btn')){ ?>
									<a href="<?=base_url('vaccine_appointment/view_appointment');?>/<?=MD5($data->ID);?>" class="dropdown-item btn btn-info  btn-xs btn-block action-btn">View Appointment</a>	
								<?php } if(checkModulePermission($MODULEID,'edit_btn')){ ?>
									<!-- <a href="<?=base_url('vaccine_appointment/addedit_appointment');?>/<?=MD5($data->ID);?>" class="dropdown-item btn btn-success btn-xs btn-block action-btn">Edit Appointment</a> -->
								<?php } if(checkModulePermission($MODULEID,'delete_btn')){ ?>
									<!-- <a href="javascript:void(0)" class="single_delete dropdown-item btn btn-danger btn-xs btn-block action-btn" id="vaccine_appointment/deleteData/<?=md5($data->ID);?>">Delete Appointment</a> -->
								<?php }?>
							</div>
						</div>
					</td>
