...
<main class="main-wrapper clearfix">
	...
	<div class="widget-body clearfix">
		...
		<div class="row">
            ...
            <div class="row">
                <label for="dose_name"style="color: #8cc63f;">NOTE: </label>&nbsp; 
                <small style="color: #8cc63f;">Dose duration 'FROM MONTH' and 'TO MONTH' must be in month(s) only, not in year(s).</small>
			...
			<thead>
				...
				<tr>
                                        ...
                                        <input type="text" maxlength="20" class="form-control" name="dose_name[]"   value="<?php echo isset($row->dose_name)?$row->dose_name:''; ?>" required="required" data-rule-required="true" data-msg-required="Please include dose name ">
                                        </td>
                                        <td>
					...
					<td><input type="text" maxlength="5" onkeypress="return isNumberKey(event);" class="form-control" name="to_month[]"  value="<?php echo isset($row->to_month)?$row->to_month:''; ?>" required="required" data-rule-required="true" data-msg-required="Please include to month"></td>
                                        <td><span dose_id="<?=$row->ID; ?>" class="btn btn-sm btn-danger remove_dose">-</span></td>
                                        <span class="error" style="display: none;">
						<i class="error-log fa fa-exclamation-triangle"></i>
                                        </span>
                                </tr>
				...
				<tr>
                                        ...
                                        <td><input type="text" maxlength="5" onkeypress="return isNumberKey(event);" class="form-control" name="from_month[]"  value="<?php echo isset($row->from_month)?$row->from_month:''; ?>" required="required" data-rule-required="true" data-msg-required="Please include from month"></td>
					<td><input type="text" maxlength="5" onkeypress="return isNumberKey(event);" class="form-control" name="to_month[]"  value="<?php echo isset($row->to_month)?$row->to_month:''; ?>" required="required" data-rule-required="true" data-msg-required="Please include to month"></td>
                                        <td><span class="btn btn-sm btn-primary add_more_dose">+</span></td>
                                        <span class="error" style="display: none;">
						<i class="error-log fa fa-exclamation-triangle"></i>
                                        </span>
                                </tr>
					...
					<td><input type="text" maxlength="5" onkeypress="return isNumberKey(event);" class="form-control" name="to_month[]" required="required" data-rule-required="true" data-msg-required="Please include to month"></td>
						...
						<i class="error-log fa fa-exclamation-triangle"></i>
                            ...
                            <?php } ?> 
                                ...
                                <tr>
                                        <td>
                                        <input type="text" maxlength="20" class="form-control" name="dose_name[]"  required="required" data-rule-required="true" data-msg-required="Please include dose name ">
                                        </td>
                                        <td>
                                            <select class="form-control" id="gender" name="gender[]" required="required" data-rule-required="true" data-msg-required="Please select patient gender.">
                                                    <option value="">Select</option>
...
<script>
    $(document).on('click','.remove_dose',function(){
        var thsedu=$(this);
        var dose_id=parseInt($(this).attr('dose_id'));
        if(dose_id>0){
            ...
            confirm_bootD(title,message,function(result) {
                    if(result){
                        $.post('<?=base_url(); ?>vaccine/remove_dose',{id:dose_id},function(data){
                            var dt=JSON.parse(data);
                            if(dt.status>0){
                                bootbox.alert(dt.msg,function(){
...
<script>
    $(document).ready(function() {
        $('.add_more_dose').click(function(){
        var htmleducation='<tr><td><input type="text" maxlength="20" class="form-control" name="dose_name[]"  required="required" data-rule-required="true" data-msg-required="Please include dose name "></td><td><select class="form-control" id="gender" name="gender[]" required="required" data-rule-required="true" data-msg-required="Please select patient gender."><option value="">Select</option><option value="1">Male</option><option value="2">Female</option><option value="3">Both</option></select></td><td><input type="text" class="form-control" name="from_month[]" maxlength="5" onkeypress="return isNumberKey(event);" required="required" data-rule-required="true" data-msg-required="Please include from month"></td><td><input type="text" class="form-control" name="to_month[]" maxlength="5" onkeypress="return isNumberKey(event);"  required="required" data-rule-required="true" data-msg-required="Please include to month"></td><td><span class="btn btn-sm btn-danger remove_dose">-</span></td><span class="error" style="display: none;"><i class="error-log fa fa-exclamation-triangle"></i></span></tr>';
        $('.add_dose').append(htmleducation);
